...
void ofApp::buttonSelectionPointControle_1() {
    selected_ctrl_point = &ctrl_point1;
}

void ofApp::buttonSelectionPointControle_2() {
    selected_ctrl_point = &ctrl_point17;
}

void ofApp::buttonSelectionPointControle_3() {
    selected_ctrl_point = &ctrl_point21;
}

void ofApp::buttonSelectionPointControle_4() {
    selected_ctrl_point = &ctrl_point4;
}

void ofApp::buttonSelectionPointControle_5() {
    selected_ctrl_point = &ctrl_point5;
}

void ofApp::buttonSelectionPointControle_6() {
    selected_ctrl_point = &ctrl_point20;
}

void ofApp::buttonSelectionPointControle_7() {
    selected_ctrl_point = &ctrl_point24;
}

void ofApp::buttonSelectionPointControle_8() {
    selected_ctrl_point = &ctrl_point8;
}

void ofApp::buttonSelectionPointControle_9() {
    selected_ctrl_point = &ctrl_point29;
}

void ofApp::buttonSelectionPointControle_10() {
    selected_ctrl_point = &ctrl_point25;
}

void ofApp::buttonSelectionPointControle_11() {
    selected_ctrl_point = &ctrl_point32;
}

void ofApp::buttonSelectionPointControle_12() {
    selected_ctrl_point = &ctrl_point28;

}

void ofApp::buttonSelectionPointControle_13() {
    selected_ctrl_point = &ctrl_point26;
}

void ofApp::buttonSelectionPointControle_14() {
    selected_ctrl_point = &ctrl_point27;
}

void ofApp::buttonSelectionPointControle_15() {
    selected_ctrl_point = &ctrl_point30;
}

void ofApp::buttonSelectionPointControle_16() {
